...
<html style="font-size: 16px;">
  <head>
    ...
    <title>Login PYME</title>
    <link rel="stylesheet" href="nicepage.css" media="screen">
<link rel="stylesheet" href="Login-PYME.css" media="screen">
    ...
    <meta property="og:title" content="Login PYME">
    ...
    <section class="u-align-center u-clearfix u-image u-shading u-section-1" src="" data-image-width="150" data-image-height="97" id="sec-09a7">
      <div class="u-align-center u-clearfix u-sheet u-sheet-1">
        ...
        <div class="u-form u-form-1">
          <form action="login_pyme" method="POST" class="u-clearfix u-form-spacing-10 u-form-vertical u-inner-form" source="custom" name="form" style="padding: 10px;">
            <div class="u-form-group u-form-name">
              <label for="name-707b" class="u-form-control-hidden u-label"></label>
              <input type="text" placeholder="Ingrese su cédula juridica/telefono/email" id="name-707b" name="identificador" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="">
            </div>
            <div class="u-form-group">
              <label for="email-707b" class="u-form-control-hidden u-label"></label>
              <input type="text" placeholder="Ingrese su clave" id="email-707b" name="clave" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="required">
            </div>
            <div class="u-align-center u-form-group u-form-submit">
              <a href="Index_PYME.jsp" onclick="location.href = 'Index_PYME.jsp';" class="u-btn u-btn-round u-btn-submit u-button-style u-radius-11">Login<br>
              </a>
