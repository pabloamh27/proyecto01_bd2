...
<link rel="stylesheet" href="Consultar-Ventas.css" media="screen">
    ...
    <meta property="og:title" content="Consultar Ventas">
  ...
  <body class="u-body"><header class="u-clearfix u-header u-header" id="sec-d39c"><div class="u-align-left u-clearfix u-sheet u-valign-middle u-sheet-1">
    ...
    <section class="u-align-center u-clearfix u-image u-shading u-section-1" src="" data-image-width="150" data-image-height="97" id="sec-09a7">
      <div class="u-align-center u-clearfix u-sheet u-sheet-1">
        <h2 class="u-text u-text-default u-text-1">Consultar Ventas</h2>
        <div class="u-form u-form-1">
          <form action="#" method="POST" class="u-clearfix u-form-spacing-10 u-form-vertical u-inner-form" source="custom" name="form" style="padding: 10px;">
            <div class="u-form-group">
              <label for="email-707b" class="u-form-control-hidden u-label"></label>
              <input type="text" placeholder="Ingrese el mes a consultar" id="email-707b" name="nombre_cliente" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="required">
            </div>
