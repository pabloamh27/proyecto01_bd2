...
<link rel="stylesheet" href="Buscar-Producto.css" media="screen">
    ...
    <meta property="og:title" content="Buscar Producto">
  ...
  <body class="u-body"><header class="u-clearfix u-header u-header" id="sec-d39c"><div class="u-align-left u-clearfix u-sheet u-valign-middle u-sheet-1">
    ...
    <section class="u-align-center u-clearfix u-image u-shading u-section-1" src="" data-image-width="150" data-image-height="97" id="sec-58b1">
      <div class="u-align-center u-clearfix u-sheet u-sheet-1">
        <h2 class="u-text u-text-default u-text-1">Buscar producto</h2>
        <div class="u-form u-form-1">
          <form action="#" method="POST" class="u-clearfix u-form-spacing-10 u-form-vertical u-inner-form" source="custom" name="form" style="padding: 10px;">
            <div class="u-form-group u-form-name">
              <label for="name-707b" class="u-form-control-hidden u-label"></label>
              <input type="text" placeholder="Ingrese el nombre del producto a buscar" id="name-707b" name="nombre_producto" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="">
            </div>
            <div class="u-align-left u-form-group u-form-submit">
              <a href="#" class="u-btn u-btn-round u-btn-submit u-button-style u-radius-11">Buscar<br>
              </a>
        ...
        <h4 class="u-text u-text-2">Nombre:</h4>
        <h4 class="u-text u-text-3">Descripción:</h4>
        <h4 class="u-text u-text-4">Precio:</h4>
      </div>
    </section>
