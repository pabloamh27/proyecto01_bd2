...
<html style="font-size: 16px;">
  <head>
    ...
    <title>Consultar_Ordenes</title>
    <link rel="stylesheet" href="nicepage.css" media="screen">
<link rel="stylesheet" href="Consultar_Ordenes.css" media="screen">
    ...
    <meta property="og:title" content="Consultar_Ordenes">
  ...
  <body class="u-body"><header class="u-clearfix u-header u-header" id="sec-d39c"><div class="u-align-left u-clearfix u-sheet u-valign-middle u-sheet-1">
    ...
    <section class="u-align-center u-clearfix u-image u-shading u-section-1" src="" data-image-width="150" data-image-height="97" id="sec-09a7">
      <div class="u-align-center u-clearfix u-sheet u-sheet-1">
        <h2 class="u-text u-text-default u-text-1">Consultar Ordenes</h2>
        <div class="u-form u-form-1">
          <form action="#" method="POST" class="u-clearfix u-form-spacing-10 u-form-vertical u-inner-form" source="custom" name="form" style="padding: 10px;">
            <div class="u-form-checkbox u-form-group u-form-group-1">
              <input type="checkbox" id="checkbox-3401" name="checkbox-1" value="On">
              <label for="checkbox-3401" class="u-label">Ordenes Activas</label>
            </div>
            <div class="u-form-checkbox u-form-group u-form-group-2">
              <input type="checkbox" id="checkbox-dfe5" name="checkbox-2" value="On">
              <label for="checkbox-dfe5" class="u-label">Ordenes Canceladas</label>
            </div>
            <div class="u-align-left u-form-group u-form-submit">
              <a href="#" class="u-btn u-btn-round u-btn-submit u-button-style u-radius-11">Consultar<br>
              </a>
