...
<html style="font-size: 16px;">
  <head>
    ...
    <title>Registro PYME</title>
    <link rel="stylesheet" href="nicepage.css" media="screen">
<link rel="stylesheet" href="Registro-PYME.css" media="screen">
    ...
    <meta property="og:title" content="Registro PYME">
        ...
        <div class="u-form u-form-1">
          <form action="registro_pyme" method="POST" class="u-clearfix u-form-spacing-10 u-form-vertical u-inner-form" source="custom" name="form" style="padding: 10px;">
            ...
            <div class="u-form-group">
              ...
              <input type="text" placeholder="Ingrese el nombre de su PYME" id="email-707b" name="nombre_pyme" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="required">
            </div>
            <div class="u-form-group">
            ...
            <div class="u-form-group u-form-group-4">
              ...
              <input type="text" placeholder="Ingrese su telefono" id="text-4086" name="telefono_pyme" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="required">
            </div>
            <div class="u-form-group u-form-group-5">
              <label for="text-0f1c" class="u-form-control-hidden u-label"></label>
              <input type="text" placeholder="Ingrese su clave" id="text-0f1c" name="clave" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="required">
            </div>
